    ...
    <section id="features" className="relative mx-auto max-w-7xl px-4 py-24">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {ITEMS.map((item, i) => (
          ...
          >
            <Card className="group h-full p-6 transition-colors hover:border-accent-400/30">
              <div className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-accent-500/10 text-accent-300 ring-1 ring-inset ring-accent-400/20 transition-colors group-hover:bg-accent-500/15">
